...
PAX::Capture - document the Capture component within the PAX compiler, packaging, or runtime stack.

=head1 DESCRIPTION

This file is part of the maintained PAX Perl surface and exists to document the Capture component within the PAX compiler, packaging, or runtime stack.
